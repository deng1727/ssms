...
import com.aspire.dotcard.a8.task.A8SingerImportTask;

public class A8SingerImportTimer
{
	private static final JLogger logger = LoggerFactory.getLogger(A8SingerImportTimer.class);
   ...
   public static void start ()
   {
       ...
       try
       {
           String SynStartTime = A8ParameterConfig.SingerSynStartTime ;
       ...
       if("week".equals(A8ParameterConfig.SingerSynFrequency))
       {
       ...
       timer.schedule(new A8SingerImportTask(), firstExecTime.getTime(), taskIntervalMS) ;
       if (logger.isDebugEnabled())
       {
           logger.debug("schedule a A8SingerImportTask,first start time is:" + firstExecTime) ;
       }
   }
