...
public class BaseBookFtpProcess {
	private static JLogger logger = LoggerFactory
			.getLogger(BaseBookFtpProcess.class);
	...
	public void init() {
		...
		this.ftpDir = BaseBookConfig.get("FTPDir");
		this.localDir = BaseBookConfig.get("localDir");
		this.ip = BaseBookConfig.get("FTPServerIP");
		this.port = Integer.parseInt(BaseBookConfig.get("FTPServerPort"));
		this.user = BaseBookConfig.get("FTPServerUser");
		this.password = BaseBookConfig.get("FTPServerPassword");
