...
public class OtPPMSChange {
	/**
     * 日志对象
     */
    protected static JLogger LOG = LoggerFactory.getLogger(OtPPMSChange.class);
    ...
    public static  void start ()
    {
        ...
        timer.schedule(new OtPPMSChangeTask(), 1000, interval*1000*60) ;
