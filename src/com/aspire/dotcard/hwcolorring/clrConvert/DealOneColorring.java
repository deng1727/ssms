package com.aspire.dotcard.hwcolorring.clrConvert;
...
import com.aspire.dotcard.hwcolorring.clrLoad.ColorContentDAO;
import com.aspire.dotcard.hwcolorring.clrLoad.ColorringConfig;
import com.aspire.dotcard.hwcolorring.clrLoad.GColorring;
    ...
    public void colorringConvert()
    {
        ...
        catch (Exception e)
        {
            ...
            if (totalResult)
            {
            	...
            	try
				{
					ColorContentDAO.getInstance().updateColorring(this.clrVO);
