 ...
 * @version
 */
public class BaseVideoNewTime
{
	/**
	 * 日志对象
	 */
	protected static JLogger logger = LoggerFactory
			.getLogger(BaseVideoNewTime.class);
	...
	public static void start()
	{
		...
		Timer timer = new Timer("视频二期重构方案定时任务", true);
		timer.schedule(new BaseVideoNewTask(), date.getTime(), period);
