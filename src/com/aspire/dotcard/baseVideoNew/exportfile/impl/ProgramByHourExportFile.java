...
//  临时注销FOR TEST _AIYAN 2012-07-14       
    ...
    protected Object[] getObject(String[] data)
    {
        ...
        object[0] = data[1];
        object[1] = data[2];
        object[2] = data[11];//nodeid 替换productid
        object[3] = data[4];

        object[4] = BaseVideoNewConfig.logoPath;//填写LOGOPATH
        object[5] = data[5];//填写FTPLOGOPATH
        if(data[5] != null && !data[5].equals("")){
        	String ftplogo = (String)data[5];
        	 if(ftplogo.startsWith("/")){
        		  object[6] = BaseVideoNewConfig.ProgramLogoPath + data[5];//填写p.TRUELOGOPATH
        	 }else{
        		 object[6] = BaseVideoNewConfig.ProgramLogoPath + "/"+ data[5];//填写p.TRUELOGOPATH
        	 }
        ...
        object[11] = data[9];
        object[12] = data[10];
        object[13] = data[3];//nodeid 替换productid
        object[14] = data[0];
