...
import com.aspire.dotcard.baseVideo.vo.CategoryApprovalVO;
...
public class CategoryApprovalListDAO {
	...
	public void queryCategoryApprovalList(PageResult page,Map map) throws DAOException{
        ...
        String sqlCode = "com.aspire.dotcard.baseVideo.dao.CategoryApprovalListDAO.queryCategoryApprovalList";
...
//        	 sql = SQLCode.getInstance().getSQLStatement(sqlCode);
        	 ...
        	 */
     		...
     		{
     			sqlBuffer.append(" and C.BASENAME like '%"+categoryName+"%'");
     		}
    ...
    private class CategoryApprovalPageVO implements PageVOInterface
    {
    	...
    	public CategoryApprovalPageVO(String operation){
         ...
         throws SQLException{
    		 ...
    		 categoryApproval.setCategoryName(rs.getString("BASENAME"));
    		 categoryApproval.setSortId(rs.getString("sortId"));
    		 if("1".equals(this.operation)){
    			 categoryApproval.setApprovalStatus(rs.getString("VIDEO_STATUS"));
