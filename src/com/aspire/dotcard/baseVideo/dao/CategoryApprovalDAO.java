...
public class CategoryApprovalDAO {
	...
	public Map<String, Object> queryCategoryListItem(String categoryId)
		...
		try {
			rs = DB.getInstance()
					.queryBySQLCode(
							"com.aspire.dotcard.baseVideo.dao.CategoryApprovalDAO.queryCategoryListItem",
			...
			logger.error("查询视频货架表异常", e);
			throw new BOException("查询视频货架表异常", e);
	...
	public void categoryApprovalPass(TransactionDB tdb, String status,String categoryId) throws BOException {
		try {
			tdb.executeBySQLCode(
					"com.aspire.dotcard.baseVideo.dao.CategoryApprovalDAO.categoryApprovalPass",
	...
	public void deleteNoPass(TransactionDB tdb, String categoryId) throws BOException {
		try {
			tdb.executeBySQLCode(
					"com.aspire.dotcard.baseVideo.dao.CategoryApprovalDAO.deleteNoPass",
					new Object[] {categoryId});
		} catch (DAOException e) {
    ...
    public boolean isApproval(String categoryId,String status) throws BOException{
    	String sqlCode = "com.aspire.dotcard.baseVideo.dao.CategoryApprovalDAO.isApproval";
		ResultSet rs = null;
		try {
			...
			logger.error("查询视频商品表发生异常:", e);
			throw new BOException("查询视频商品表发生异常:", e);
		} catch (SQLException e) {
			logger.error("查询视频商品表发生异常:", e);
			throw new BOException("查询视频商品表发生异常:", e);
		}
    		...
    		try {
    		   String[] strs = contentId[i].split("#");
    			...
    			if(!"2".equals(map.get("delflag"))){
    				...
    				tdb.executeBySQLCode("com.aspire.dotcard.baseVideo.dao.CategoryApprovalDAO.categoryGoodsApproval", new Object[]{approvalStatus,categoryId,strs[0]});
    			}
			} catch (DAOException e) {
				logger.error("单个视频商品提交审批异常:", e);
				throw new BOException("单个视频商品提交审批异常:", e);
			}
    	}
    ...
    public void categoryApproval(TransactionDB tdb,String categoryId,String status) throws BOException{
    	try {
			tdb.executeBySQLCode("com.aspire.dotcard.baseVideo.dao.CategoryApprovalDAO.categoryApproval", new Object[]{status,categoryId});
		} catch (DAOException e) {
			logger.error("更新视频货架表中商品的状态异常:", e);
			throw new BOException("更新视频货架表中商品的状态异常:", e);
		}
    }
    ...
    public void categoryGoodsAllApproval(TransactionDB tdb,String categoryId,String approvalStatus,String status) throws BOException{
    	try {
			tdb.executeBySQLCode("com.aspire.dotcard.baseVideo.dao.CategoryApprovalDAO.categoryGoodsAllApproval", new Object[]{approvalStatus,categoryId,status});
		} catch (DAOException e) {
			logger.error("全部视频商品提交审批异常:", e);
			throw new BOException("全部视频商品提交审批异常:", e);
		}
	...
	public List<Map<String, Object>> queryCategoryGoodsList(String categoryId)
		...
		try {
			rs = DB.getInstance()
					.queryBySQLCode(
							"com.aspire.dotcard.baseVideo.dao.CategoryApprovalDAO.queryCategoryGoodsList",
							new Object[] { categoryId });
			while (rs != null && rs.next()) {
				Map<String, Object> map = new HashMap<String, Object>();
			...
			logger.error("根据货架id查询待审批视频商品异常：", e);
			throw new BOException("根据货架id查询待审批视频商品异常：", e);
		} catch (DAOException e) {
			logger.error("根据货架id查询待审批视频商品异常：", e);
			throw new BOException("根据货架id查询待审批视频商品异常：", e);
		} finally {
	...
	public void deleteCategoryGoodsItem(TransactionDB tdb,String id) throws BOException{
		try {
			tdb.executeBySQLCode("com.aspire.dotcard.baseVideo.dao.CategoryApprovalDAO.deleteCategoryGoodsItem", new Object[]{id});
		} catch (DAOException e) {
			logger.error("删除一条视频商品异常：", e);
			throw new BOException("删除一条视频商品异常：", e);
		}
		
	}
	/**
	 * 单条视频商品审核不同过时，删除的商品的状态进行回滚
	 * 
	 * @param tdb
	 * @param id 动漫商品id
	 * @throws BOException
	...
	public void callBackCategoryGoodsItem(TransactionDB tdb,String id) throws BOException{
		try {
			tdb.executeBySQLCode("com.aspire.dotcard.baseVideo.dao.CategoryApprovalDAO.callBackCategoryGoodsItem", new Object[]{id});
		} catch (DAOException e) {
			logger.error("单条视频商品审核不同过时，删除的商品的状态进行回滚异常：", e);
			throw new BOException("单条视频商品审核不同过时，删除的商品的状态进行回滚异常：", e);
		}
	...
	public Map<String, Object> queryGoodsItem(String contentId)
		...
		try {
			rs = DB.getInstance()
					.queryBySQLCode(
							"com.aspire.dotcard.baseVideo.dao.CategoryApprovalDAO.queryGoodsItem",
			...
			logger.error("根据视频商品id查询待审批视频商品异常：", e);
			throw new BOException("根据视频商品id查询待审批视频商品异常：", e);
		} catch (DAOException e) {
			logger.error("根据视频商品id查询待审批视频商品异常：", e);
			throw new BOException("根据视频商品id查询待审批视频商品异常：", e);
		} finally {
	...
	public void approvalCategoryGoodsItem(TransactionDB tdb, String id) throws BOException {
		try {
			tdb.executeBySQLCode(
					"com.aspire.dotcard.baseVideo.dao.CategoryApprovalDAO.approvalCategoryGoodsItem",
					new Object[] { id });
		} catch (DAOException e) {
			logger.error("一条视频商品记录提交审批异常：", e);
			throw new BOException("一条视频商品记录提交审批异常：", e);
		}
