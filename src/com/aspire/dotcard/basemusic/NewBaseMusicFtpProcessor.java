...
public class NewBaseMusicFtpProcessor 
{
	private static JLogger logger = LoggerFactory.getLogger(NewBaseMusicFtpProcessor.class);
	...
	public void init()
	{
		...
		this.ftpDir = BaseMusicConfig.get("NewFTPDir");
		this.localDir = BaseMusicConfig.get("NewlocalDir");
		this.ip = BaseMusicConfig.get("NewFTPServerIP");
		this.port = Integer.parseInt(BaseMusicConfig.get("NewFTPServerPort"));
		this.user = BaseMusicConfig.get("NewFTPServerUser");
		this.password = BaseMusicConfig.get("NewFTPServerPassword");
