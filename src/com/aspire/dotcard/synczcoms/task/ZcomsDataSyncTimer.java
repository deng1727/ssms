 ...
 *
 */
public class ZcomsDataSyncTimer {

	 /**
     * 日志对象
     */
    protected static JLogger logger = LoggerFactory.getLogger(ZcomsDataSyncTimer.class);
    ...
    public static void start()
    {
        ...
        timer.schedule(new ZcomsDataSyncTask(),date,period);
//        new ZcomsDataSyncTask().run();
    }
}
