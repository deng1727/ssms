...
public class HotcontentExportFile extends BaseExportFile{

	public HotcontentExportFile()
	{
		this.tableName = "t_v_hotcontent";
		this.fileName = "~Dyyyy-MM-dd\\yyyy-MM-dd~_HOTCONTENT.txt";
		this.verfFileName = "~Dyyyy-MM-dd\\yyyy-MM-dd~_HOTCONTENT.verf";
		this.mailTitle = "新基地视频热点主题列表数据同步结果";
