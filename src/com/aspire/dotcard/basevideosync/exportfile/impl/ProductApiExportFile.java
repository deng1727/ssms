...
public class ProductApiExportFile extends BaseExportFile {

	public ProductApiExportFile()
	{
		this.mailTitle = "新基地视频计费数据api请求同步结果";
	}
	...
	public void init()
	{
		...
		this.dataList = BaseVideoDAO.getInstance().getApiRequestParamter("03");
		this.apiRequest = 1;
		this.hasVerf = false;
	}
