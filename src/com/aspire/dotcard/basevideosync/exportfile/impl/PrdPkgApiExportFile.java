...
public class PrdPkgApiExportFile extends BaseExportFile{

	public PrdPkgApiExportFile()
	{
		this.mailTitle = "新基地视频业务产品数据api请求同步结果";
	}
	...
	public void init()
	{
		...
		this.dataList = BaseVideoDAO.getInstance().getApiRequestParamter("02");
		this.apiRequest = 1;
		this.hasVerf = false;
	}
	...
	protected String checkData(String[] data) {
		...
		{
			logger.error("servid=" + servid
					+ ",propkgtype验证错误，该字段是必填字段，长度不超过21个字符！ propkgtype=" + tmp);
			return BaseVideoConfig.CHECK_FAILED;
		}
