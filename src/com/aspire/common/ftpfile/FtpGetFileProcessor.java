 ...
 *
 */
public class FtpGetFileProcessor 
{
	private static JLogger logger = LoggerFactory.getLogger(FtpGetFileProcessor.class);
	 ...
	 */
	public void init(String FTPDir, String localDir, String FTPServerIP,
			String FTPServerPort, String FTPServerUser, String FTPServerPassword)
	{
		// this.fNameRegex =BaseMusicConfig.get("fNameRegex").split(",");
		//this.fName = new String[fNameRegex.length];
		this.ftpDir = FTPDir;//BaseMusicConfig.get("NewFTPDir");
		this.localDir = localDir;//BaseMusicConfig.get("NewlocalDir");
		this.ip = FTPServerIP;//BaseMusicConfig.get("NewFTPServerIP");
		this.port = Integer.parseInt(FTPServerPort);
		this.user = FTPServerUser;//BaseMusicConfig.get("NewFTPServerUser");
		this.password = FTPServerPassword;//BaseMusicConfig.get("NewFTPServerPassword");
	 ...
	 * @throws BOException
	 */
	public String[] process(String [] fNameRegex,String FTPDir, String localDir, String FTPServerIP,
			String FTPServerPort, String FTPServerUser, String FTPServerPassword)throws BOException
	{
		this.init(FTPDir,localDir,FTPServerIP,FTPServerPort,FTPServerUser,FTPServerPassword);
		FTPClient ftp = null;
		this.fName=new String[fNameRegex.length];
		try
		{
