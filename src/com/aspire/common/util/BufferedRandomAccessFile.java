...
//////////////////////////////  END CUT & PASTE FROM RandomAccessFile
     ...
     */
    public BufferedRandomAccessFile(File file, String mode, int bufferSize) throws
        IOException {
        this(file, mode);
     ...
     * @exception  IOException Description of Exception
     */
    protected BufferedRandomAccessFile(File file, String mode) throws
        IOException {
...
//////////////////////////////  BEGIN CUT & PASTE FROM RandomAccessFile
        ...
        if (currBuf.pos + len <= currBuf.dataLen) {
            ...
            if (currBuf.dataLen < currBuf.bytes.length) {
                ...
                if (currBuf.dataLen <= len) {
                    ...
                    //                  (currBuf.filePos + currBuf.pos) + ")");
                    delegate.seek(currBuf.filePos);
                    //System.out.println(" * delegate.read(byte[" + b.length +
                    //                  "], " + pos + ", " + len + ")");
    ...
    public void write(byte[] b, int pos, int len) throws IOException {
        ...
        //System.out.println("buf len"+ currBuf.bytes.length);
    ...
    public void write(int b) throws IOException {
        //System.out.println("Write " + (char) b + " currBuf.pos=" + currBuf.pos +
        //                  ", currBuf.dataLen=" + currBuf.dataLen);
