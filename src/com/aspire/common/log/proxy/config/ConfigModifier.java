 ...
 * @version 1.0
 * history:
 * created at 21/4/2003
 * updated at 24/5/2003,don't add duplicated JMSAppender
 */
...
public class ConfigModifier implements ConfigModifierMBean,LogErrorCode
{
  ...
  /**
   * disable user's realtime filter and trace function
   * it means remove the channel for publishing log message
