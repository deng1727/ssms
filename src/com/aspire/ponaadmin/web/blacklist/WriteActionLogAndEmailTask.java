package com.aspire.ponaadmin.web.blacklist;

import java.util.Map;

import com.aspire.common.db.DAOException;
import com.aspire.ponaadmin.web.blacklist.dao.BlackListEmailDAO;
import com.aspire.ponaadmin.web.blacklist.dao.BlockListLoggerDao;
...
public class WriteActionLogAndEmailTask extends DaemonTask{
	...
	public void execute() {
		...
		try {
			BlockListLoggerDao.getInstance().addLogger(map);
			String emailAddress = BlackListEmailDAO.getInstance()
					.getMailAddress(map);
