 ...
 * @version 
 */
public class BookCategoryCityAction extends BaseAction
{
    /**
     * 日志引用
     */
    private static final JLogger logger = LoggerFactory.getLogger(BookCategoryCityAction.class) ;
                    ...
                    throws BOException
    {
        ...
        }else
        {
            ...
            CategoryCityBO.getInstance().queryBookCityList(page, city, categoryID, pCategoryID);
        }
