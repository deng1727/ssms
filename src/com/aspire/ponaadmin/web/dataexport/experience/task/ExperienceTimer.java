...
public class ExperienceTimer
{
     ...
     * 日志对象
     */
    protected static JLogger logger = LoggerFactory.getLogger(ExperienceTimer.class);
    ...
    public static void start()
    {
        ...
        //从配置项中得到任务的启动时间
        String syncDataTime = ExperienceConfig.STARTTIME;
        //得到启动的小时和分钟
        int syncDataHours = 0;
        int syncDataMin = 0;
        ...
        timer.schedule(new ExperienceTask(),date,period);
    }
}
