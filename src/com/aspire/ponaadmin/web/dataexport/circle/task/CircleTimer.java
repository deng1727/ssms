...
public class CircleTimer
{
     ...
     * 日志对象
     */
    protected static JLogger logger = LoggerFactory.getLogger(CircleTimer.class);
    ...
    public static void start()
    {
        ...
        //从配置项中得到任务的启动时间
        String syncDataTime = ConfigFactory.getSystemConfig()
        .getModuleConfig("circle").getItemValue("startTime");//startTime
        //得到启动的小时和分钟
        int syncDataHours = 0;
        int syncDataMin = 0;
        ...
        timer.schedule(new CircleTask(),date,period);
    }
}
