 ...
 * @version
 */
public class SearchFileGameByJTForWAP extends SearchFileBase
{
    /**
     * 注册订阅到发布者上
     * 
     ...
     * @throws BOException
     */
    public SearchFileGameByJTForWAP(SearchFileSubject subject)
                    throws BOException
    {
        // 注册订阅者至发布者
        ...
        // 游戏类型
        this.type = RepositoryConstants.TYPE_APPGAME;

        // 全网应用 jt文件名的是查為G的，不加jt文件名的是查全部信息
        this.servattr = SearchFileConstants.SERVATTR_G;

        // 生成文件类型。WAP
        this.relation = SearchFileConstants.RELATION_A;

        // 生成文件名
        this.fileName = "appGame.jt.txt";
