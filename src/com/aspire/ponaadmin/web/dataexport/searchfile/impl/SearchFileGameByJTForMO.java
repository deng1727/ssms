 ...
 * @version
 */
public class SearchFileGameByJTForMO extends SearchFileBase
{
    /**
     * 注册订阅到发布者上
     * 
     ...
     * @throws BOException
     */
    public SearchFileGameByJTForMO(SearchFileSubject subject)
                    throws BOException
    {
        // 注册订阅者至发布者
        ...
        // 生成文件类型。MO
        this.relation = SearchFileConstants.RELATION_O;
