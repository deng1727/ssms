 ...
 * @version 
 */
public class CategoryCityAction extends BaseAction
{
    /**
     * 日志引用
     */
    private static final JLogger logger = LoggerFactory.getLogger(CategoryCityAction.class) ;
                    ...
                    throws BOException
    {
    	if(request.getSession() == null || UserManagerBO.getInstance()
    		...
    		this.saveMessages(request, "用户未登陆或者登陆超时！");
        ...
        }else
        {
            ...
            CategoryCityBO.getInstance().queryCityList(page, city, categoryID, pCategoryID);
        }
