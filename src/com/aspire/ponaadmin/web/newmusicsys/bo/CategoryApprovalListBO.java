...
import com.aspire.ponaadmin.web.newmusicsys.dao.CategoryApprovalListDAO;

public class CategoryApprovalListBO {

	private final static JLogger LOGGER = LoggerFactory
			.getLogger(CategoryApprovalListBO.class);
	...
	public void queryCategoryApprovalList(PageResult page, Map map)
		...
		try {
			CategoryApprovalListDAO.getInstance().queryCategoryApprovalList(
					page, map);
