 ...
 * @version
 */
public class NewMusicCategoryDAO
{

    /**
     * 记录日志的实例对象
     */
    protected static JLogger logger = LoggerFactory.getLogger(NewMusicCategoryDAO.class);

    /**
     * singleton模式的实例
     */
    private static NewMusicCategoryDAO instance = new NewMusicCategoryDAO();

    /**
     * 构造方法，由singleton模式调用
     */
    private NewMusicCategoryDAO()
    {
    }
     ...
     * @return 实例
     */
    public static NewMusicCategoryDAO getInstance()
    {
        return instance;
    }
     ...
     * @throws BOException
     */
    public void delNewMusicCategory(TransactionDB tdb,String categoryId) throws DAOException
    {
        ...
        // update t_r_category c set c.delflag=1 where c.categoryid=?
        String sqlCode = "newmusicsys.NewMusicCategoryDAO.delNewMusicCategory().del";
     ...
     * @throws DAOException 
     */
    public int delNewMusicCategoryKeyResource(TransactionDB tdb,String tid) throws DAOException
	{
		if (logger.isDebugEnabled())
		{
			logger.debug("updateNewMusicCategory() is starting ...");
