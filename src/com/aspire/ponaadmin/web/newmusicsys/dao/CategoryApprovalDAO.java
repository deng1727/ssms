...
public class CategoryApprovalDAO {
	...
	public Map<String, Object> queryCategoryListItem(String categoryId)
		...
		try {
			...
			logger.error("查询音乐货架表异常", e);
			throw new BOException("查询音乐货架表异常", e);
	...
	public void categoryApprovalPass(TransactionDB tdb, String status,
		...
		try {
			...
			logger.error("更新音乐货架审批状态发生异常：", e);
			throw new BOException("更新音乐货架审批状态发生异常：", e);
		}
	...
	public void deleteNoPass(TransactionDB tdb, String categoryId)
		...
		try {
			...
			logger.error("审核不通过，删除的音乐货架回滚到原来的状态发生异常", e);
			throw new BOException("审核不通过，删除的音乐货架回滚到原来的状态发生异常", e);
		}
	}
	...
	public boolean isApproval(String categoryId, String status)
		...
		try {
			...
			logger.error("查询音乐商品表发生异常:", e);
			throw new BOException("查询音乐商品表发生异常:", e);
		} catch (SQLException e) {
			logger.error("查询音乐商品表发生异常:", e);
			throw new BOException("查询音乐商品表发生异常:", e);
		}
	...
	public void categoryGoodsApproval(TransactionDB tdb, String[] contentId,
		...
		for (int i = 0; i < contentId.length; i++) {
			try {
				...
				logger.error("单个音乐商品提交审批异常:", e);
				throw new BOException("单个音乐商品提交审批异常:", e);
			}
		}
	...
	public void categoryApproval(TransactionDB tdb, String categoryId,
		...
		try {
			...
			logger.error("更新音乐货架表中商品的状态异常:", e);
			throw new BOException("更新音乐货架表中商品的状态异常:", e);
		}
	}
	...
	public void categoryGoodsAllApproval(TransactionDB tdb, String categoryId,
		...
		try {
			...
			logger.error("全部音乐商品提交审批异常:", e);
			throw new BOException("全部音乐商品提交审批异常:", e);
		}
	...
	public List<Map<String, Object>> queryCategoryGoodsList(String categoryId)
		...
		try {
			...
			logger.error("根据货架id查询待审批音乐商品异常：", e);
			throw new BOException("根据货架id查询待审批音乐商品异常：", e);
		} catch (DAOException e) {
			logger.error("根据货架id查询待审批音乐商品异常：", e);
			throw new BOException("根据货架id查询待审批音乐商品异常：", e);
		} finally {
	...
	public void deleteCategoryGoodsItem(TransactionDB tdb, String id,
		...
		try {
			...
			logger.error("删除一条音乐商品异常：", e);
			throw new BOException("删除一条音乐商品异常：", e);
		}

	}

	/**
	 * 单条音乐商品审核不同过时，删除的商品的状态进行回滚
	 * 
	 * @param tdb
	 * @param id
	 *            音乐商品id
	...
	public void callBackCategoryGoodsItem(TransactionDB tdb, String id,
		...
		try {
			...
			logger.error("单条音乐商品审核不同过时，删除的商品的状态进行回滚异常：", e);
			throw new BOException("单条音乐商品审核不同过时，删除的商品的状态进行回滚异常：", e);
		}
	...
	public Map<String, Object> queryGoodsItem(String contentId,
		...
		try {
			...
			logger.error("根据音乐商品id查询待审批音乐商品异常：", e);
			throw new BOException("根据音乐商品id查询待审批音乐商品异常：", e);
		} catch (DAOException e) {
			logger.error("根据音乐商品id查询待审批音乐商品异常：", e);
			throw new BOException("根据音乐商品id查询待审批音乐商品异常：", e);
		} finally {
	...
	public void approvalCategoryGoodsItem(TransactionDB tdb, String id,
		...
		try {
			...
			logger.error("一条音乐商品记录提交审批异常：", e);
			throw new BOException("一条音乐商品记录提交审批异常：", e);
		}
