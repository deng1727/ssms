...
/**
 * <p>Title:NextStepPageTag </p>
 * <p>XP_DB00011612  新增分页标签</p>
 * <p>Description:分页中的下翻页 WAP PORTAL3.0.3  2006.10.22 </p>
 *
 ...
 * @version 1.0
 */
public class NextStepPageTag extends TagSupport {
...
/**
   * 日志引用
   */
  protected static JLogger log = LoggerFactory.getLogger(NextStepPageTag.class) ;
   ...
   */
    ...
    */
    public String getLocation() {
        ...
        //最后一页所在step区间
        int lastScope=(tag.getTotalPages()-1)/stepInteger;
        //当前页所在区间大于或等于最后一页所在区间，则下翻页标签以文本形式显示，无链接内容
        ...
        //当前页所在区间小于最后一页所在区间，则下翻页标签以链接形式显示，并指向下一个区间的第一页
        } else {
            buf.append("<a href=\"");
