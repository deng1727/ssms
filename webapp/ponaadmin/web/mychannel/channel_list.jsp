...
<table width="95%"  border="0" align="center" cellspacing="1" bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="17%" align="center" class="title1">渠道ID</td>     
    <td width="20%" align="center" class="title1">渠道类型</td>
    <td width="20%" align="center" class="title1">渠道名称</td> 
    <td width="20%" align="center" class="title1">创建时间</td> 
    <td width="20%" align="center" class="title1">操作</td> 
  </tr>
  <logic:iterate id="vo" indexId="ind" name="PageResult" property="pageInfo" type="com.aspire.ponaadmin.webpps.mychannel.vo.MyChannelVO">
		...
		<td align="center">
      	...
      	<td align="center">
      			 <logic:equal value="0" name="vo" property="channelType">下载渠道包</logic:equal>
      		</td>
		</tr>
  </logic:iterate>
</table>
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1" >
  <tr bgcolor="#B8E2FC">
    <td align="center" >
		<input name="buttonAdd" type="button" class="input1" onClick="apply();" value="申请">
		<logic:notEmpty name="PageResult" property="pageInfo">
