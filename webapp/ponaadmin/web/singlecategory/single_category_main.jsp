...
<frameset rows="*" cols="170,*" framespacing="0" frameborder="yes" border="0">
  <frame src="../singlecategory/single_category_tree.jsp?userId=<%=userId %>&type=<%=type %>" name="leftFrame1" scrolling="auto">
  <frame src="../resourcemgr/category_main_notes.jsp?subSystem=ssms" name="mainFrame1">
</frameset>
<noframes><body>
</body></noframes>
</html>
