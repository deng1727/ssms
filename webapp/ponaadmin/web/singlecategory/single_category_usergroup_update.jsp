			...
			<table width="95%" border="0" align="center" cellspacing="1"
				...
				<tr>
					...
					<td class="text4">
						...
						<logic:equal name="type"  value="1">货架分类</logic:equal> 
						<logic:equal name="type"  value="2">货架商品</logic:equal> 
					</td>
				</tr>
				
				<tr align="center" class="text3">
					<td colspan="2">
						<input name="button2" type="button" onClick="add();" value="修改">
						&nbsp;&nbsp;
