...
{
	var returnv=window.showModalDialog("../baseRead/categoryTree.do?perType=city&isFirst=1&pCategoryID=<bean:write name="pCategoryId" />&categoryID=<bean:write name="readVO" property="id"/>", "new","width=800,height=500,toolbar=no,scrollbars=yes,menubar=no,resizable=true ")
	var name = "";
	var htmp = "";
	if(returnv != undefined)
	{
...
<body bgcolor="#F0FBFD" leftmargin="0" topmargin="5" onLoad="load();">
	<form name="form1" method="post" action="categorySave.do" enctype="multipart/form-data" onSubmit="return checkForm(form1);">
	...
	<table width="95%"  border="0" align="center" cellspacing="1" bgcolor="#FFFFFF">
	  ...
	  <tr>
	    <td width="25%" align="right" class="text3">
	      ...
	      <input type="hidden" name="oldName" value="<bean:write name="readVO" property="categoryName"/>">
	      <input type="hidden" name="pCategoryId" value="<bean:write name="pCategoryId" />">
	      <input type="hidden" name="categoryId" value="<bean:write name="readVO" property="id"/>">
	      <input type="hidden" name="oldPicURL" value="<bean:write name="readVO" property="picUrl"/>">
	      <input name="catalogType" type="hidden" value="0" checked>
	      <font color="#ff0000">(*)</font>货架名称：
	    </td>
	    <td width="75%" class="text4"><input name="name" type="text" value="<bean:write name="readVO" property="categoryName"/>" size="50">
	    </td>
	  </tr>
	  <tr>
	    <td align="right" class="text3">货架描述：</td>
	    <td class="text4"><textarea name="decrisption" cols="50"><bean:write name="readVO" property="decrisption"/></textarea>
	    </td>
	  </tr>
	  <tr>
	    <td align="right" class="text3">是否在门户展示：</td>
	    <td class="text4">
			<input name="type" type="radio" value="1" <logic:equal value="1" name="readVO" property="type">checked</logic:equal>>是
			<input name="type" type="radio" value="0" <logic:equal value="0" name="readVO" property="type">checked</logic:equal>>否
	    </td>
	  </tr>
	  <tr>
	    <td align="right" class="text3">货架排序信息：</td>
	    <td class="text4">
	    	<input name="sortId" type="text" value='<bean:write name="readVO" property="sortId"/>' size='8'/>
	    </td>
	  </tr>
	  ...
	  <tr>
	    <td align="right" class="text3">图片引用：</td>
	    <td class="text4">
      		<input type="file" name="dataFile">
      		<font color="red">&nbsp;&nbsp;&nbsp;&nbsp;仅支持jpg和png格式</font>
      		<logic:notEqual value="" name="readVO" property="picUrl">
      			<input type="checkbox" value="1" name="clearPicUrl"/>
      			清空当前图片引用
      		</logic:notEqual>
      		<logic:equal value="" name="readVO" property="picUrl">
      			<input type="checkbox" value="1" name="clearPicUrl" disabled="disabled"/>
      			清空当前图片引用
      		</logic:equal><bean:write name="readVO" property="picUrl"/>
	    </td>
	  </tr>
