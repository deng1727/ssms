...
function search()
{
	QueryForm.action = "../queryapp/QueryAppAction.do?opType=doQueryAddList";
	QueryForm.submit();
}

function exportApp()
{
	QueryForm.action = "../queryapp/QueryAppAction.do?opType=doExport&type=add";
	QueryForm.submit();  
}
		...
		<table width="95%" border="0" align="center" cellspacing="1" bgcolor="#FFFFFF">
		  <tr>
			...
			<tr>
				...
				<td width="30%" class="text4">
					<select name="syntype">
						<option value=""   <logic:equal name="syntype" value="">selected="selected"</logic:equal>  >全部</option>
						<option value="1"  <logic:equal name="syntype" value="1">selected="selected"</logic:equal> >上线</option>
						<option value="2"  <logic:equal name="syntype" value="2">selected="selected"</logic:equal> >更新</option>
					</select>
				</td>
				<td width="20%" align="center" class="text3">
				</td>
					...
					<logic:notEmpty name="PageResult">
						<logic:iterate id="vo" indexId="ind" name="PageResult" property="pageInfo" type="com.aspire.ponaadmin.web.queryapp.vo.QueryAppVO">
							<tr <%=ind.intValue()%2== 0 ? "class=\'text4\'" : "class=\'text3\'"%>>
								...
								<td align="center" style='word-break:break-all'>
									<logic:equal name="vo" property="syntype"  value="1">上线</logic:equal>
									<logic:equal name="vo" property="syntype"  value="2">更新</logic:equal>
								</td>
			...
			<logic:notEmpty name="PageResult">
				<logic:notEmpty name="PageResult" property="pageInfo">
					<tr class="text1">
						...
						<td align="right">
							<pager:pager name="PageResult" form="QueryForm" action="/web/queryapp/QueryAppAction.do?opType=doQueryAddList">
