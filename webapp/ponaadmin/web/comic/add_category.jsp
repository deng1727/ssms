	...
	<table width="95%"  border="0" align="center" cellspacing="1" bgcolor="#FFFFFF">
	  <tr>
	    <td width="25%" align="right" class="text3">
	      ...
	      <input type="hidden" name="parentCategoryId" value="<bean:write name="categoryVO" property="parentCategoryId" />">
	  ...
	  <tr>
	    ...
	    <td class="text4">
			<input name="delFlag" type="radio" value="0" checked>是
			<input name="delFlag" type="radio" value="1">否
	    </td>
	  </tr>
	</table>
	<table width="95%"  border="0" align="center" cellspacing="1" bgcolor="#FFFFFF">
