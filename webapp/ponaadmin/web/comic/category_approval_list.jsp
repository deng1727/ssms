...
<%@page import="com.aspire.ponaadmin.web.comic.vo.CategoryApprovalVO"%>
<%@page
...
function showCategoryInfo(categoryID) {
	window
			.open("categoryTree.do?operation=1&method=query&categoryId=" + categoryID,
					"new",
			...
			<table width="95%" border="0" align="center" cellspacing="3"
				...
				%>
						<pager:pager name="PageResult"
							action="/web/comic/categoryApprovalList.do" params="<%=params%>">
