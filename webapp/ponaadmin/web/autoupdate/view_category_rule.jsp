			...
			<tr>
				...
				<td class="text4">
					<select name="ruleType" onChange="selectRuleType();">
						...
						<option value="7"><%=CategoryUpdateConfig.getInstance().getShowValue("ruleType","7") %></option>
		  ...
		  <tr class="text5">
			...
			<logic:iterate id="vo" indexId="ind" name="PageResult" property="pageInfo" type="com.aspire.ponaadmin.web.category.rule.condition.ConditionVO">
				...
				<tr class=<%=tmpStyle%>>
					...
					<td align="center">
						<%=CategoryUpdateConfig.getInstance().getShowValue("condType",String.valueOf(vo.getCondType())) %>
					</td>
		      		<td align="center">
