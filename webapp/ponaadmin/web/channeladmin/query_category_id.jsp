	...
	<logic:iterate id="vo" indexId="ind" name="PageResult" property="pageInfo" type="com.aspire.ponaadmin.web.repository.Category">
		...
		<tr class=<%=tmpStyle%>>
			<td align="center" style="word-break:break-all;">
				<input type="radio" name="id" value="<bean:write name="vo" property="categoryID"/>" />
			</td>
      		<td align="center">
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1" >
  <tr bgcolor="#B8E2FC">
    <td align="right" >
        ...
        %>
        <pager:pager name="PageResult" form="ContentForm" action="/web/channeladmin/categoryRuleIdQuery.do" params="<%=params%>">
