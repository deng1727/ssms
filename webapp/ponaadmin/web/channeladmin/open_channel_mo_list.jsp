	...
	<body bgcolor="#F3F7F8" leftmargin="0" topmargin="5">
		...
		<form name="ContentForm" action="openChannelMoList.do?method=list" method="post">
				...
				<table width="95%" border="0" align="center" cellspacing="1"
					...
					<logic:iterate id="vo" indexId="i" name="PageResult" property="pageInfo" type="com.aspire.ponaadmin.web.channeladmin.vo.OpenChannelMoVo">
						<tr class=<%=i % 2 == 0 ? "text4" : "text5"%>>
							...
							<td align="center">
								<a style="color: #0000FF" href="#" onclick="delClient(<%=vo.getChannelId()%>,<%=vo.getChannelsId()%>)">删除</a>
							</td>
						</tr>
					</logic:iterate>
				</table>
			...
			<table width="95%" border="0" align="center" cellpadding="0"
				...
				<tr bgcolor="#B8E2FC">
					<td align="center">
						<input type="button" value="添加客户端渠道配置" onclick="addClient(<%=request.getAttribute("channelsId")%>);">
