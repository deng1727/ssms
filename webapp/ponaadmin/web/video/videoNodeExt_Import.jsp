...
<table width="95%"  border="0" align="center" cellspacing="1" bgcolor="#FFFFFF">
  <tr>
    <td>所在位置：货架管理中心----视频栏目说明信息批量导入</td>
  </tr>
</table>
<table width="95%"  border="0" align="center" cellspacing="3">
  <tr class="title1">
    <td align="center"><FONT class=large>栏目说明信息批量导入</FONT></td>
  </tr>
</table>
<form action="../baseVideo/videoNode.do" name="form1" method="post" enctype="multipart/form-data">
<table width="95%"  border="0" align="center" cellspacing="3">
...
<tr><td><font color="red">*提示，导入格式为 普通xls文件格式，第一列为栏目ID,第二列为栏目描述（不超过300个汉字）</font><br/>  	
</td>
</tr>
</table>
</body>
