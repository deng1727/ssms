				...
				<tr>
					...
					<td width="30%" class="text4">
						<select name="statusinfo" style="width:120px">
							<option value="" <%="".equals(statusinfo)?"selected":"" %>>所有</option>
							<option value="1" <%="1".equals(statusinfo)?"selected":"" %>>LUCENE中存在，数据库中不存在</option>
							<option value="2" <%="2".equals(statusinfo)?"selected":"" %>>LUCENE中不存在，数据库中存在</option>
						</select>
					</td>
				</tr>
				<tr>
				...
				<table width="95%" border="0" align="center" cellspacing="1"
					...
					<logic:iterate id="vo" indexId="ind" name="PageResult"
						...
						<tr class=<%=tmpStyle%>>
							...
							<td align="center">
								<logic:equal name="vo" property="statusinfo"  value="1">LUCENE中存在，数据库中不存在</logic:equal>
								<logic:equal name="vo" property="statusinfo"  value="2">LUCENE中不存在，数据库中存在</logic:equal>
							</td>
