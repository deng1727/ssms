	...
	<table width="95%"  border="0" align="center" cellspacing="1" bgcolor="#FFFFFF">
	  ...
	  <tr>
	   ...
	   <tr>
	    ...
	    <logic:notEqual value="" name="newMusicCategory" property="albumPic">
      			<input type="checkbox" value="1" name="clear_albumPic"/>
      			清空当前字段内容
      		</logic:notEqual> 
	    </td>
	  </tr>
	  ...
	  <tr>
	    ...
	    <td class="text4">
			<input name="type" type="radio" value="1" <logic:equal value="1" name="newMusicCategory" property="type">checked</logic:equal>>是
			<input name="type" type="radio" value="0" <logic:equal value="0" name="newMusicCategory" property="type">checked</logic:equal>>否
	    </td>
	  </tr>
	    ...
	    <td class="text4">
			<input name="cateType" type="radio" value="1" <logic:equal value="1" name="newMusicCategory" property="cateType">checked</logic:equal>>是
			<input name="cateType" type="radio" value="0" <logic:equal value="0" name="newMusicCategory" property="cateType">checked</logic:equal>>否
	    </td>
	  </tr>
