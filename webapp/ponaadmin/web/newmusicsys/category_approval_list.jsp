...
<%@page import="com.aspire.ponaadmin.web.newmusicsys.vo.CategoryApprovalVO"%>
<%@page
...
function showCategoryInfo(categoryID) {
	window
			.open("categoryTree.do?operation=1&perType=query&categoryId=" + categoryID,
					"new",
	...
	<body bgcolor="#F0FBFD" leftmargin="0" topmargin="0">
		...
		<table width="95%" border="0" align="center" cellspacing="1">
			<form name="queryUserForm"
				action="categoryApprovalList.do"
			...
			<table width="95%" border="0" align="center" cellspacing="3"
				...
				%>
						<pager:pager name="PageResult"
							action="/web/newmusicsys/categoryApprovalList.do" params="<%=params%>">
