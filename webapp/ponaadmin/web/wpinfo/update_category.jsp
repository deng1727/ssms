...
<body bgcolor="#F0FBFD" leftmargin="0" topmargin="5" >
	...
	<table width="95%"  border="0" align="center" cellspacing="1" bgcolor="#FFFFFF">
	  ...
	  <tr>
	    ...
	    <td class="text4">
			<input name="isShow" type="radio" value="1" <logic:equal value="1" name="appInfoCategoryVO" property="isShow">checked</logic:equal>>是
			<input name="isShow" type="radio" value="0" <logic:equal value="0" name="appInfoCategoryVO" property="isShow">checked</logic:equal>>否
	    </td>
	  </tr>
	  <tr>
