...
if(id==null){
	...
	for(int i=0;i<nodeList.size();i++){
		...
		out.print("{id:"+node.getId()+",pId:"+node.getParentId()+",name:'"+node.getName()+"',url:'../wpInfo/appInfoReference.do?perType=query&categoryId="+node.getId()+"',isParent:'true',target:'mainFrame1'}");	
