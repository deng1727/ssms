              ...
              <td width="155" align=left>
                ...
                <a href="#" onClick="expandIt('KB2'); return false">
                  ...
                  <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" background="../../image/but_pic03.gif">
                    <tr>
                      <td width="8%"><img src="../../image/but_pic01.gif" width="10" height="24"></td>
                      <td width="84%"><img src="../../image/tree/arrow.gif" width="15" height="15" border="0" align="absmiddle"> <a href="#" class="link2" onClick="expandIt('KB2'); return false">渠道版合作</a> </td>
                      <td width="8%" align="right"><img src="../../image/but_pic02.gif" width="10" height="24"></td>
                    </tr>
                  </table>
                </div>
                ...
                <a href="#" onClick="expandIt('KB3'); return false">
                  ...
                  <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" background="../../image/but_pic03.gif">
                    <tr>
                      <td width="8%"><img src="../../image/but_pic01.gif" width="10" height="24"></td>
                      <td width="84%"><img src="../../image/tree/arrow.gif" width="15" height="15" border="0" align="absmiddle"> <a href="#" class="link2" onClick="expandIt('KB3'); return false">TAC码库管理</a> </td>
                      <td width="8%" align="right"><img src="../../image/but_pic02.gif" width="10" height="24"></td>
                    </tr>
                  </table>
                ...
                <div id='KB3Child' class='child'>
                  <table width="95%"  border="0" align="center">
                    <tr>
                      <td width="13%" align="center">&nbsp;</td>
                      <td width="87%">
                        <img src="../../image/icon/icon013.gif" align="absmiddle">&nbsp;<a href="../channelUser/tacCode.do?perType=query" target="mainFrame">TAC码库管理</a>
                      </td>
                    </tr>
                  </table>
                ...
                <a href="#" onClick="expandIt('KB4'); return false">
                  ...
                  <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" background="../../image/but_pic03.gif">
                    <tr>
                      <td width="8%"><img src="../../image/but_pic01.gif" width="10" height="24"></td>
                      <td width="84%"><img src="../../image/tree/arrow.gif" width="15" height="15" border="0" align="absmiddle"> <a href="#" class="link2" onClick="expandIt('KB4'); return false">配置推送管理</a> </td>
                      <td width="8%" align="right"><img src="../../image/but_pic02.gif" width="10" height="24"></td>
                    </tr>
                  </table>
                  </right:checkMenuDisplay>
                ...
                <a href="#" onClick="expandIt('KB5'); return false">
                  ...
                  <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" background="../../image/but_pic03.gif">
                    <tr>
                      <td width="8%"><img src="../../image/but_pic01.gif" width="10" height="24"></td>
                      <td width="84%"><img src="../../image/tree/arrow.gif" width="15" height="15" border="0" align="absmiddle"> <a href="#" class="link2" onClick="expandIt('KB5'); return false">我的渠道</a> </td>
                      <td width="8%" align="right"><img src="../../image/but_pic02.gif" width="10" height="24"></td>
                    </tr>
                  </table>
                </div>
                ...
                <script>numTotal=5;scores[1]='KB1';scores[2]='KB2';scores[3]='KB3';scores[4]='KB4';scores[5]='KB5';</script>
              </td>
            </tr>
</table>
</body>
