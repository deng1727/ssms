...
{
	var returnv=window.showModalDialog("<%=root%>/web/channelUser/categoryDevice.do?isFirst=1", "new","width=800,height=500,toolbar=no,scrollbars=yes,menubar=no,resizable=true ")
	var name = "";
	var htmp = "";
...
function openPlatFormId(){
	var returnv = window.showModalDialog("<%=request.getContextPath()%>/web/channelUser/categoryPlatForm.do?isFirst=1", "new","width=800,height=500,toolbar=no,scrollbars=yes,menubar=no,resizable=true ")
	var name = "";
	var htmp = "";
	if(returnv != undefined)
	{
...
function openCityId(){
	window.open("<%=root%>/web/channelUser/categoryCity.do?isFirst=1&pCategoryID=<bean:write name="pCategoryID" />&categoryID=<bean:write name="category" property="id"/>", "new","width=800,height=500,toolbar=no,scrollbars=yes,menubar=no,resizable=true ")
}
...
<form name="form1" method="post" action="<%=root%>/web/channelUser/categorySave.do" enctype="multipart/form-data" onSubmit="return checkForm(form1);">
