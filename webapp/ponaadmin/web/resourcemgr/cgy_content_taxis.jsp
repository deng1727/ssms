...
function modTaxis()
{
 ...
 // var url = "<%=request.getContextPath()%>/web/resourcemgr/cgyContentTaxis.do?action=save&refid="+id+"&cateid="+cateid;
 
  //document.location = url;
    sortForm.action="<%=request.getContextPath()%>/web/resourcemgr/cgyContentTaxis.do?action=save";
