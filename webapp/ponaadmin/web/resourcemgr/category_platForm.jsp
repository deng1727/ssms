...
<table width="95%"  border="0" align="center" cellspacing="3" bgcolor="#FFFFFF">
  <tr>
    <td align="center" bgcolor="#BFE8FF">平台列表</td>
  </tr>
</table>
<form name="ContentForm" action="categoryPlatForm.do" method="post">
<table width="95%"  border="0" align="center" cellspacing="3" bgcolor="#FFFFFF">
  <tr>
...
<table width="95%"  border="0" align="center"  cellspacing="1" bgcolor="#FFFFFF">
	<tr bgcolor="#B8E2FC">
	  ...
	  <td width="25%" align="center" class="title1">平台编码</td>
	  <td width="45%" align="center" class="title1">平台名称</td>
	</tr>
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1" >
  <tr bgcolor="#B8E2FC">
    <td align="right" >
        ...
        %>
        <pager:pager name="PageResult" form="ContentForm" action="/web/resourcemgr/categoryPlatForm.do" params="<%=params%>">
