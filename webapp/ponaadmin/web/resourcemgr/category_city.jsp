...
<form name="ContentForm" action="categoryCity.do" method="post">
<table width="95%"  border="0" align="center" cellspacing="3" bgcolor="#FFFFFF">
  <tr>
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1" >
  <tr bgcolor="#B8E2FC">
    <td align="right" >
        ...
        %>
        <pager:pager name="PageResult" form="ContentForm" action="/web/resourcemgr/categoryCity.do" params="<%=params%>">
