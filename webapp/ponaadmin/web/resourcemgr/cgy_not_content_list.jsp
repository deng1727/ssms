...
function addContent()
{
  ...
  contentForm.action='cgyContentAdd.do?isClose=true&categoryID=<bean:write name="category" property="id"/>&menuStatus=<%=menuStatus%>';
...
function addContentToCgy()
{
  ...
  contentForm.action="contentAddToCgy.do?&menuStatus=<%=menuStatus%>";
  contentForm.submit();
}
...
<table width="95%"  border="0" align="center" cellspacing="1" bgcolor="#FFFFFF">
  <form name="contentListForm" action="cgyNotContentList.do?subSystem=ssms" method="post" onSubmit="return checkPageSize(contentListForm.pageSize);">
  <tr>
...
<tr>
    ...
    <td width="30%" class="text4"><input type="text" name="pageSize" value="<%=pageSize%>" ></td>
     ...
     <tr>
    <td width="18%" align="right" class="text3">聚合应用ID：</td>
  ...
  <tr>
    <td align="right" class="text1">
       ...
       // params.put("keywordid",keywordid);
        ...
        %>
        <pager:pager name="PageResult" form="contentListForm" action="/web/resourcemgr/cgyNotContentList.do?subSystem=ssms" params="<%=params%>">
...
<table width="95%"  border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="7%" align="center" class="title1">内容ID</td>
  ...
  <tr class=<%=tmpStyle%>>
    ...
    <td align="center"><a href="contentInfo.do?contentID=<bean:write name="content" property="id"/>&categoryID=<bean:write name="category" property="id"/>&backURL=<%=backURL_enc%>"><bean:write name="content" property="id"/></a></td>
    <td align="center" style="word-break:break-all;"><a href="contentInfo.do?contentID=<bean:write name="content" property="id"/>&categoryID=<bean:write name="category" property="id"/>&backURL=<%=backURL_enc%>"><bean:write name="content" property="name"/></a></td>
