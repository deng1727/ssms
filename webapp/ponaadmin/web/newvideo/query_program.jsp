...
<form name="refForm" action="videoReference.do" method="post" >
<table width="95%"  border="0" align="center" cellspacing="1" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td width="30%" class="text4"><input type="text" name="cmsId" value="<%=cmsId%>"></td>
  </tr>
  <tr>
...
<logic:equal name="isFirst" value="">
	...
	<logic:notEmpty name="PageResult" property="pageInfo">
		...
		<table width="95%"  border="0" align="center" cellspacing="1" bgcolor="#FFFFFF">
		  ...
		  <logic:iterate id="vo" indexId="ind" name="PageResult" property="pageInfo" type="com.aspire.dotcard.basevideosync.vo.ProgramVO">
			    <%
				...
				<tr class=<%=tmpStyle%>>
					<td align="center" style="word-break:break-all;">
						<input type="checkbox" name="dealRef" value="<bean:write name="vo" property="programId"/>_<bean:write name="vo" property="CMSID"/>_<bean:write name="vo" property="name"/>">
					</td>
					<td align="center">
		      		...
		      		<td align="center">
		      			<bean:write name="vo" property="CMSID"/>
		      		</td>
		      		<td align="center">
						<bean:write name="vo" property="updatetimev"/>
					</td>
				</tr>
		  </logic:iterate>
		</table>
		<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1" >
		  <tr bgcolor="#B8E2FC">
		    <td align="right" >
		        ...
		        %>
		        <pager:pager name="PageResult" form="refForm" action="/web/newVideo/videoReference.do" params="<%=params%>">
