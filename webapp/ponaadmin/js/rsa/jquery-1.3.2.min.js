...
(function(window, undefined){
 ...
 callbacks = [],            // stored [ context , args ]
    ...
    jQuery.event = {
        ...
        handle: function(event){
            ...
            {})[event.type] || []).slice(0), run_all = !event.exclusive && !event.namespace, args = Array.prototype.slice.call(arguments, 0);
 ...
 : function(elem, type, handle){
    ...
    var ralpha = /alpha\([^)]*\)/i, ropacity = /opacity=([^)]*)/, rdashAlpha = /-([a-z])/ig,    // fixed for IE9, see #8346
 ...
 rinput = /^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,    // #7653, #8125, #8152: local protocol detection
    ...
    jQuery.extend({
        ...
        ajax: function(url, options){
            ...
            var jid = jQuery.getJid();
            
            if (jid != null) {
            
                if (typeof options.data == "string") {
                    options.data += "&jid=" + jid;
                }
                else {
                    options.data.jid = jid;
                }
 ...
 s = jQuery.ajaxSetup({}, options),            // Callbacks context
            ...
            (callbackContext.nodeType || callbackContext instanceof jQuery) ? jQuery(callbackContext) : jQuery.event,            // Deferreds
...
jQuery.extend({
    ...
    getJid: function(){
        ...
        return jQuery.mmHashCode(jQuery.getMMCookie('JSESSIONID'));
        ;
    }
...
jQuery(document).ready(function(){
    ...
    var jid = jQuery.getJid();
    if (jid != null && jid != "") {
        jQuery("form").append("<input type='hidden' name='jid' value='" + jid + "' ></input>");
        jQuery.each(jQuery("a"), function(){
            var obj = jQuery(this);
            var url = obj.attr('href');
            if (url && url != "#" && url.indexOf('javascript:') == -1 && url.indexOf('(') == -1 && url.indexOf(')') == -1) {
