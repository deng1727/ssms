...
(function(){
	...
	//rsa password
	window.RSAEncryption = function(public_length,public_key ,passwordvalue){
		var biRadixBase = 2;
		var biRadixBits = 16;
		...
		setMaxDigits(130);  
	    var key = new RSAKeyPair(public_length,"",public_key);  
		return  encryptedString(key, passwordvalue);
	};
