...
<%
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////
  //
  //      公用成功页面，goURL表示返回的url，targetFrame表示目标frame
  //
  //////////////////////////////////////////////////////////////////////////////////////////////
  ...
  String refreshTreeKey = (String)request.getAttribute(Constants.PARA_REFRESH_TREE_KEY);
  if(refreshTreeKey == null || refreshTreeKey.trim().equals(""))
  {
    refreshTreeKey = request.getParameter(Constants.PARA_REFRESH_TREE_KEY);
  }
  
  //add by aiyan del_node
  String del_node_cgyPath = (String)request.getAttribute("del_node_cgyPath");
...
<!--
function refresh(mykey)
{	
  var obj= window.parent.frames("treeframe");
  if(mykey==-1){
    obj.refresh();
  }
  else
...
//add by aiyan begin
<%if(del_node_cgyPath!=null){%>
	  parent.frames["leftFrame1"].del_node("<%=del_node_cgyPath%>");
  <%}%>
 //end
