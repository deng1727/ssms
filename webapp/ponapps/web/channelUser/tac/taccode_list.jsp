...
String channelId = Validator.filter(request.getParameter("channelId")==null?"":request.getParameter("channelId"));
String channelName = Validator.filter(request.getParameter("channelName")==null?"":request.getParameter("channelName"));
%>
<html>
<head>
...
<form name="refForm" action="tacCode.do" method="post" >
	<table width="95%"  border="0" align="center" cellspacing="1" bgcolor="#FFFFFF">
	  ...
	  <tr>
	    <td width="15%" align="right" class="text3">TAC码：</td>
	    <td width="20%" class="text4"><input type="text" name="tacCode" value="<%=tacCode%>"></td>
	    <td width="15%" align="right" class="text3">手机品牌：</td>
	    <td width="20%" class="text4"><input type="text" name="brand" value="<%=brand%>"></td>
	    <td width="15%" align="right" class="text3">渠道名：</td>
	    <td width="20%" class="text4"><input type="text" name="channelName" value="<%=channelName%>"></td>
	  </tr>
	  <tr>
	    <td width="15%" align="right" class="text3">手机型号：</td>
	    <td width="20%" class="text4"><input type="text" name="device" value="<%=device%>"></td>
	    <td width="15%" align="right" class="text3">渠道号</td>
	    <td width="20%" class="text4"><input type="text" name="channelId" value="<%=channelId%>"></td>
	    <td width="15%" align="right" class="text3"></td>
	    <td width="20%" class="text4"></td>
	  </tr>	  
	  <tr>
	    <td colspan="6" align="center" class="text5">
		...
		<table width="95%"  border="0" align="center" cellspacing="1" bgcolor="#FFFFFF">
		  <tr>
		    ...
		    <input type="checkbox" value='' name="allSelect" onclick="selectAllCB(refForm,'dealRef',this.checked,false);"/>
		  	...
		  	<td width="10%" align="center" class="title1">渠道名称</td> 
		    <td width="10%" align="center" class="title1">TAC码</td>     
		    <td width="10%" align="center" class="title1">手机品牌</td>
		    <td width="10%" align="center" class="title1">手机型号</td>
		  ...
		  <logic:iterate id="vo" indexId="ind" name="PageResult" property="pageInfo" type="com.aspire.ponaadmin.web.taccode.vo.TacVO">
				...
				<tr class=<%=tmpStyle%>>
					...
					<td align="center">
		      			<bean:write name="vo" property="channelId"/>
		      		</td>
		      		<td align="center">
					...
					<td align="center" style="word-break: break-all">
				       <input name="ad" type="button" onClick="removeTac('<bean:write name="vo" property="id" />','<bean:write name="vo" property="tacCode" />');" value="删除"/>
				    </td>
		      		<%-- <td align="center">
	...
	<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1" >
	  <tr bgcolor="#B8E2FC">
	    <td align="center" >
			...
			<input name="buttonAdd" type="button" onclick="importData()" value="批量导入推送">
	    </td>
	  </tr>
	</table>
	...
	<table width="95%"  border="0" align="center" cellspacing="3">
	  <tr>
	    ...
	    <td align="left" width="80%">
			<input type="file" name="dataFile">(表格第一列为渠道ID,第二列为渠道名,第三列为TAC码,第四列为手机品牌,第五列为手机型号)
	    </td>
	</table>
</form>
</body>
