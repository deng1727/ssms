...
<form name="ContentForm" action="<%=request.getContextPath()%>/web/channelUser/categoryCity.do" method="post">
<table width="95%"  border="0" align="center" cellspacing="3" bgcolor="#FFFFFF">
  <tr>
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="1" >
  <tr bgcolor="#B8E2FC">
    <td align="right" >
        ...
        %>
        <pager:pager name="PageResult" form="ContentForm" action="/web/channelUser/categoryCity.do" params="<%=params%>">
...
function fReturn()
{
    ...
    if(obj!=null){
        ...
        if(city_id_value.length>0){
        	city_id_value = "["+city_id_value.substring(1)+"]";
        }else{
        	city_id_value = "[]";
        }
    }
	window.opener.selectCityId(city_id_value);
    window.close();
}
</script>
</body>
