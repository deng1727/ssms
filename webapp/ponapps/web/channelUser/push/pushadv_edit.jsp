...
<body bgcolor="#F0FBFD" leftmargin="0" topmargin="5">
	...
	<form name="form1" method="post" action="pushAdv.do?style=edit&id= <bean:write name="editVO" property="id" /> "
		...
		<table width="95%" border="0" align="center" cellspacing="1"
			...
			<tr>
				...
				<td width="75%" class="text4"><select name="catename" id="catename" >
						<option value="0" 
							<logic:equal  name="editVO" property="type" value="0">selected="selected"</logic:equal>>应用推送</option>
						<option value="1" 
							<logic:equal  name="editVO" property="type"  value="1">selected="selected"</logic:equal>>媒体化文章推送</option>
						<option value="2" 
							<logic:equal  name="editVO" property="type"  value="2">selected="selected"</logic:equal>>Deeplink页面推送</option>
						<option value="3"
							<logic:equal  name="editVO" property="type"  value="3">selected="selected"</logic:equal>>营销活动推送</option>
			...
			<tr>
				...
				<td width="75%" class="text4"><input name="contentId"
					id="contentId" type="text" size="30" value="<bean:write name="editVO" property="contentId" />"> <input type="button"
			...
			<tr>
				...
				<td width="75%" class="text4"><input name="title" type="text"
					value="<bean:write name="editVO" property="title" />" size="100">  
				</td>
			</tr>
			<tr>
				<td align="right" class="text3">副标题：</td>
				<td class="text4"><input name="subTitle" type="text" value="<bean:write name="editVO" property="subTitle" />"
					size="100">
				</td>
			</tr>
			...
			<tr>
				...
				<td class="text4"><input name="uri" type="text" value="<bean:write name="editVO" property="uri" />"
					size="100">
				</td>
			</tr>
			...
			<tr>
				...
				<td class="text4"><input name="startTime" class="Wdate"
					...
					onFocus="new WdatePicker(this,'%Y-%M-%D %H:%m:%S',true)" value="<bean:write name="editVO" property="startTime" />" />
				</td>
			</tr>
			<tr>
				...
				<td class="text4"><input name="endTime" class="Wdate"
					type="text" id="textbox2" style="width:170px"
					onFocus="new WdatePicker(this,'%Y-%M-%D %H:%m:%S',true)" value="<bean:write name="editVO" property="endTime" />" />
				</td>
			</tr>
			<tr>
					...
					<table>
						<tr>
							...
							<td><select id="select2" name="reDevice" multiple="multiple"
								style="width:300px;height:350px">
								<logic:iterate id="device" name="SelectedDevice">
												<option class="device" selected = "selected" value="<bean:write name="device"/>">
													<bean:write name="device" />
												</option>
									</logic:iterate>
					...
					<table>
						<tr>
							...
							<td><select id="select22" name="bversions" multiple="multiple"
								style="width:300px;height:350px">
								<logic:iterate id="version" name="selectedVersions">
												<option class="version" selected = "selected" value="<bean:write name="version"/>">
													<bean:write name="version" />
												</option>
									</logic:iterate>
							</select>
		...
		<table width="95%" border="0" align="center" cellspacing="1"
			...
			<tr>
				<td align="center" class="text5"><input name="Submit"
					type="submit" class="input1" value="保存" onclick="importData('<bean:write name="editVO" property="id" />');">
				</td>
			</tr>
		</table>
	</form>
