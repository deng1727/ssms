...
function ChangeAnotherImg()
	{
	var img=document.getElementById("authcode");
	var AllSrc=img.src;
	if(AllSrc.endWith('.pa=0')){
	  img.src= "<%=request.getContextPath()%>/randomNumImg?..pa=1";
	}
	else{
	   img.src="<%=request.getContextPath()%>/randomNumImg?.pa=0";
	}
	//img.src="/randomNumImg?pa="+new Date().getTime();
	} 
</script>
</head>
            ...
            <td valign="bottom" class="text1">
              ...
              <table width="80%" height="103"  border="0" align="center" cellpadding="2" cellspacing="3">
                ...
                <tr>
                  ...
                  <td><input name="imgCode" type="text" size="10" maxlength="4" align="absmiddle" value=""><img src="<%=request.getContextPath()%>/randomNumImg?.pa=<%=System.currentTimeMillis()%>" id="authcode" onclick="ChangeAnotherImg()" align="absmiddle"></td>
                </tr>
                <tr>
