...
function editor_action(button_id) {
  ...
  if (cmdID == 'popupeditor') {
    window.open(_editor_url + "fullscreen.html?"+objname,
                'FullScreen',
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
    ...
    // insert image
      ...
      //showModalDialog("../resourcemgr/content_upload.jsp", editdoc, "resizable: no; help: no; status: no; scroll: no; ");
      showModalDialog("../../web/resourcemgr/content_upload.jsp", editdoc, "resizable: no; help: no; status: no; scroll: no; ");
    }
