...
try{
 	ifs=tempWin.parent.document.getElementsByTagName('iframe');
}catch(e1)
{
	ifs=tempWin.parent.document.getElementsByTagName('frame');
}
...
this.top=window;
while(this.top.parent.window!=this.top.window&&this.top.parent.frames.length==0){this.top=this.top.parent;}
