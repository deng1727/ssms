...
delete from t_mb_category_new where CATEGORYID='100000006';

delete from T_GAME_CATE_MAPPING;
insert into  T_GAME_CATE_MAPPING select * from T_GAME_CATE_MAPPING_bak1;
...
begin
v_nstatus:=pg_log_manage.f_startlog('P_BINDING_SORT_FINAL2','货架绑单');
...
-- Drop columns 
alter table T_EXIGENCECONTENT drop column TYPE;
alter table T_EXIGENCECONTENT drop column SUBTYPE;

-- Drop columns 
alter table T_GOODS_CHANGE_HIS drop column PATH;
alter table T_GOODS_CHANGE_HIS drop column CATETYPE;
alter table T_GOODS_CHANGE_HIS drop column CONTENTID;


delete DBVERSION where PATCHVERSION = 'MM1.0.3.130_SSMS' and LASTDBVERSION = 'MM1.0.3.125_SSMS';
commit;