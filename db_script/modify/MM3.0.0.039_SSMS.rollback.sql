...
alter table T_VO_NODE_MID drop column collectflag;
alter table T_VO_NODE drop column collectflag;
drop table t_vo_collect_node;
drop table t_vo_collect;

 ------回滚p_delete_insert存储过程-----
...
select NODEID, NODENAME, DESCRIPTION, PARENTNODEID, LOGOPATH, SORTID, PRODUCTID, EXPORTTIME from (
select NODEID, NODENAME, DESCRIPTION, PARENTNODEID, LOGOPATH, SORTID, PRODUCTID, EXPORTTIME,
