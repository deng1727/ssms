...
insert into t_r_base select * from t_r_base_015;
insert into t_r_reference select * from t_r_reference_015;
insert into t_r_gcontent select * from t_r_gcontent_015;
insert into t_r_category select * from t_r_category_015;
---drop t_singer
drop table t_singer;
...
select v1.companycode as icpcode,
 ...
 --删除版本信息
delete DBVERSION where PATCHVERSION = 'MM1.0.0.015_SSMS' and LASTDBVERSION = 'MM1.0.0.013_SSMS';
drop  index INDX_T_R_REF_GOODSID;
commit;