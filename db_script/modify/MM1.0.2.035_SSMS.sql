--新增地域属性
alter table T_R_GCONTENT add pvcid varchar2(10);
alter table T_R_GCONTENT add cityid varchar2(20);
-- Add comments to the columns 
comment on column T_R_GCONTENT.pvcid
  is '应用归属省的id， 0000表示全国';
comment on column T_R_GCONTENT.cityid
  is '应用归属市的id， 0000表示pvcid所指定全省业务';
...
select a.typename,
 ...
 where a.contenttype = b.contenttype
   ...
   ;
update t_r_gcontent g set g.pvcid='0000' where g.provider='B';
--添加版本----
insert into dbversion(DBSEQ,DBVERSION,LASTDBVERSION,PATCHVERSION) values (SEQ_DB_VERSION.nextval,'1.0.0.0','MM1.0.2.032_SSMS','MM1.0.2.035_SSMS');
commit;