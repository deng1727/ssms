...
--自动更新数据
delete t_caterule_cond t where t.ruleid in ('1017','1016','1015','1014');
delete t_caterule t where t.ruleid in ('1017','1016','1015','1014');

drop table T_SYNC_TACTIC_MOTO;
drop synonym S_CM_CONTENT_MOTOEXT;
drop synonym S_CM_EXT_MOTO_TYPE;
drop  view v_cm_motoext;
drop table  CM_CONTENT_MOTOEXT ;



delete DBVERSION where PATCHVERSION = 'MM1.0.3.035_SSMS' and LASTDBVERSION = 'MM1.0.3.030_SSMS';
commit;