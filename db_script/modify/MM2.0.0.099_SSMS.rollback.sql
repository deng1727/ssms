...
alter table V_CM_CONTENT_TB_TRA drop column servicecode;
alter table V_CM_CONTENT_TB drop column servicecode;
...
delete DBVERSION where PATCHVERSION = 'MM2.0.0.0.099_SSMS' and LASTDBVERSION = 'MM2.0.0.0.095_SSMS';
commit;