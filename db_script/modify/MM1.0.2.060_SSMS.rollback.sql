drop table T_BASE_TEMP;
drop view v_base_game;
drop table T_BASE_VIDEO;

drop sequence SEQ_BASEVIDEO_ID;

delete T_ROLERIGHT t where t.rightid like ('%_15%');

delete T_ROLE  t where t.roleid in (111,222,333,444);

delete T_RIGHT t where t.rightid like ('%_15%');
...
select a.typename,
 ...
 where a.contenttype = b.contenttype
   ...
   and c.thirdapptype in ('1','2','5');--增加widget应用--增加JIL应用--增加孵化应用7
...
delete DBVERSION where PATCHVERSION = 'MM1.0.2.060_SSMS' and LASTDBVERSION = 'MM1.0.2.055_SSMS';
commit;