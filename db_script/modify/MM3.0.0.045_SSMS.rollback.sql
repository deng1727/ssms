...
drop table v_iap_monitor;

alter table t_vo_product_mid drop column productdesc;
alter table t_vo_product drop column productdesc;
alter table t_vo_program_mid drop column sortid;
alter table t_vo_program drop column sortid;
alter table t_vo_program_mid drop column islink;
alter table t_vo_program drop column islink;
alter table t_vo_program_mid drop column productid;
alter table t_vo_program drop column productid;
