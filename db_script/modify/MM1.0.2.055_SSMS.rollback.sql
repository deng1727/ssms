--删除新增table和序列
drop table t_mb_music_desc;

-- Add/modify columns 体验营销数据导出榜单初始化
alter table T_CATEGORY_TRAIN drop column COUNT;

delete t_r_base b where b.id in ('14301299','14301300','14301301');

delete t_r_category y where y.id in ('14301299','14301300','14301301');
...
--------创业大赛资讯修改为新媒体------
update  t_cytomm_mapping t  set t.CYAPPCATENAME='资讯'  where t.APPCATEID='29';
update  t_cytomm_mapping t  set t.CYAPPCATENAME='视频'  where t.APPCATEID='3';
update  t_sync_tactic_cy t  set t.appcatename='视频'  where t.id in ('6','14','22');
update  t_sync_tactic_cy t  set t.appcatename='资讯'  where t.id in ('9','17','25');



delete DBVERSION where PATCHVERSION = 'MM1.0.2.055_SSMS' and LASTDBVERSION = 'MM1.0.2.050_SSMS';
commit;